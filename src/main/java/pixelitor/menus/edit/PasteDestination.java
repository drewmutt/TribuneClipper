...
public enum PasteDestination {
    NEW_LAYER {
        ...
        void addImage(BufferedImage pastedImage) {
            ...
            Layer newLayer = new ImageLayer(comp, pastedImage, "New Clip", comp.getCanvasWidth(), comp.getCanvasHeight());

            comp.addLayer(newLayer, AddToHistory.YES, "New Clip", true, false);
        }
    }, NEW_IMAGE {
