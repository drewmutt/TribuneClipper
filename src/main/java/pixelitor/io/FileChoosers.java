...
public class FileChoosers {
    ...
    public static final FileFilter jp2Filter = new FileNameExtensionFilter("JP2 files", "jp2");

    private static final FileFilter[] DEFAULT_OPEN_SAVE_FILTERS = {bmpFilter, gifFilter, jpegFilter, oraFilter, pngFilter, pxcFilter, jp2Filter};
