    ...
    public void readFileFormat() throws IOException, EOFException {
        ...
        try{
            ...
            while(!lastBoxFound){
                ...
                int x = pos;
                length = in.readInt();
                System.out.println("Reading Length | " + x + "  -  " + (x+4) + " = "+length+"");
                if((pos+length) == in.length())
                    lastBoxFound = true;

                x = in.getPos();
                box = in.readInt();
                System.out.println("\t Box ID | " + x + "  -  " + (x+4) + " = 0x"+ Integer.toHexString(box) + " (" + box+")");
                if (length == 0) {
                    lastBoxFound = true;
                    length = in.length()-in.getPos();
                } else if(length == 1) {
                    longLength = in.readLong();
                    length = (int) longLength - 8;
...
//                System.out.println("\t New Length = " + length);
                ...
                switch(box){
                    case FILE_TYPE_BOX:
                        System.out.println("\t File Type Box ");
                    ...
                    case CONTIGUOUS_CODESTREAM_BOX:
                        ...
                        break;
                    case JP2_HEADER_BOX:
                        System.out.println("\t JP2 Header Box ");
                        if(jp2HeaderBoxFound)
                    ...
                    case IMAGE_HEADER_BOX:
                        System.out.println("\t Image Header Box ");
                    ...
                    case COLOUR_SPECIFICATION_BOX:
                        System.out.println("\t Color spec Box ");
                    ...
                    case CHANNEL_DEFINITION_BOX:
                        ...
                        break;
                    case RESOLUTION_BOX:
                        System.out.println("\t Resolution Box");
                        length = 0;
                        break;
                    case CAPTURE_RESOLUTION_BOX:
                    case DEFAULT_DISPLAY_RESOLUTION_BOX:
                        System.out.println("\t Display Res Box");
                ...
                System.out.println("\t Done with box. Read from " + pos + " - " + in.getPos() + " ("+(in.getPos() - pos) + "b)");
                if(!lastBoxFound)
                {
                    in.seek(pos+length);
                }
