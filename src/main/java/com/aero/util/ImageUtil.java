...
public class ImageUtil
{
    ...
    public static double getSkewOfImage(BufferedImage image) {
    ...
    public static BufferedImage cropImageToBounds(Composition comp, Rectangle bounds) {
        ...
        BufferedImage boundsSizeImg = canvasSizedImage.getSubimage(bounds.x, bounds.y, bounds.width, bounds.height);
